              ...
              <div className='row'>
                <div className='col-12 text-center'>
                  <h3 className='mt-0 mb-0'>
                    <span className='bold'>Hair </span> Accessories
                  </h3>
                  <p className='p-lg mb-1 grey-text'>
                    Some beautiful collection of hair accessories
                  </p>
                </div>
              </div>
