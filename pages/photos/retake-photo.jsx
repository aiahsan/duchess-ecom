          ...
          <div className='container py-lg-5'>
            <div className='row pb-xl-5'>
              <div className='col-xl-4 col-lg-6 col-md-8 col-sm-10 col-12 mx-auto'>
                <h3 className='bold'>Take Your Photo</h3>
                <img
                  src='/images/take-photo.png'
                  alt=''
                  className='img-fluid mt-3'
                />
                <button className='site-btn py-2 mt-4 medium text-capitalize w-100'>
                  Use Photo
                </button>
                <button
                  className='site-btn py-2 mt-4 medium text-capitalize w-100'
                  disabled
                >
                  Retake Photo
                </button>
