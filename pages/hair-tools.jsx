    ...
    <div>
      ...
      <div className='wrapper'>
        ...
        <div>
          ...
          {/* banner ends here */}
          {/* hair-tools-collection ends here */}
          <section className='contact-us py-4 pb-lg-5'>
            <div className='container'>
              <div className='row'>
                <div className='col-12 text-center'>
                  <h3 className='mt-0 mb-0'>
                    <span className='bold'>Hair </span> Tools
                  </h3>
                  <p className='p-lg mb-1 grey-text'>
                    Eye-catching Collection of Hair Tools
                  </p>
                </div>
              </div>
              ...
              <div className='row'>
                <div className='col-lg-3 col-sm-6 mt-3'>
                  <div
                    ...
                    onClick={() => (location.href = 'product-details-options')}
                  >
                    <img
                      src='images/hair-tools-1.png'
                      alt=''
                      className='img-fluid w-100'
                    />
